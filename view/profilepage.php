...
$l = explode('&memberid',$_SERVER['REQUEST_URI']);
...
$getPosts =  pg_query($db_connection, "select * from photo where member_id = $memberid[1];");
    ...
    <div class="wrap">
		...
		<ul id="tiles">
		   ...
		   if (is_array($results) || is_object($results)){
                ...
                ?>
					<li>
                    <a href="../controller/check.php?loggedin=<?php echo $loggedinUser[0]['member_id']?>&photoid=<?php echo $result['photo_id']?>&memberid=<?php echo $memberid[1]?>"><?php echo '<img id="userimages" src="data:image/jpeg;base64,'.pg_unescape_bytea($result["imagepath"]).' " width="300" height="300"/>'?></a>
                        <div class="post-info">
                            <div class="post-basic-info">
								...
								<?php $userid =  $result['member_id'];
									$getname =  pg_query($db_connection, "select username from member where member_id='$userid';");
